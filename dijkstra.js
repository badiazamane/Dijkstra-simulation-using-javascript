...
buttonTwo.addEventListener("click", function () {
  ...
  while (
    Object.keys(unvisitedVertices).length !== 0 ||
    unvisitedVertices.constructor !== Object
  ) {
...
buttonThree.addEventListener("click", function () {
  ...
  document.getElementById("info1").innerHTML =
    "The shortest distance from the start Vertex to " +
    val1 +
    " is " +
    thePreviousvertex[val1][1];
  document.getElementById("info2").innerHTML = "Path : " + val1 + "->";
  let extraLoopCondition = false;
  while (
    (thePreviousvertex[val1][0] != val && thePreviousvertex[val1][1] != 0) ||
    !extraLoopCondition
  ) {
